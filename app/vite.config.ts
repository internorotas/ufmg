...
export default defineConfig({
  ...
  server: {
    headers: {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://*.tile.openstreetmap.org; connect-src 'self' ws: wss: https://*.tile.openstreetmap.org; font-src 'self' data:; frame-src 'none';",
    },
    fs: {
