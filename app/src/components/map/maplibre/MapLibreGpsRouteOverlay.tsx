...
export const MapLibreGpsRouteOverlay = React.memo(
  function MapLibreGpsRouteOverlay({ linha }: MapLibreGpsRouteOverlayProps) {
  ...
  (prev, next) => prev.linha.idRota === next.linha.idRota,
);
