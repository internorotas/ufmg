...
export function OfflineToast({ show }: OfflineToastProps) {
  ...
  return (
    <div
      ...
      className="fixed left-4 right-18 top-20 z-(--z-banner) rounded-lg border border-warning-border bg-warning-bg px-4 py-3 text-sm font-medium text-warning-text shadow-lg sm:left-auto sm:right-4 sm:max-w-sm"
    >
