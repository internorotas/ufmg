...
export function DataSourceBanner({ isVisible, source, updatedAt }: DataSourceBannerProps) {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-atomic="true"
      className="fixed left-4 right-4 top-20 z-1199 surface-card-sm border-warning-border bg-warning-bg px-4 py-3 text-sm font-medium text-warning-text sm:left-auto sm:max-w-md"
    >
