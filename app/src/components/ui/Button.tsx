...
export const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      secondary: [
        'bg-brand-accent text-brand-dark shadow-(--elevation-1)',
        'hover:shadow-(--elevation-2) hover:brightness-110',
        'active:shadow-none active:scale-[0.98]',
        'focus-visible:ring-focus',
      ],
      success: [
        'bg-success-solid text-text-inverse shadow-(--elevation-1)',
        'hover:shadow-(--elevation-2) hover:brightness-110',
        'active:shadow-none active:scale-[0.98]',
        'focus-visible:ring-focus',
      ],
      danger: [
        'bg-danger-solid text-white shadow-(--elevation-1)',
        'hover:shadow-(--elevation-2) hover:brightness-110',
        'active:shadow-none active:scale-[0.98]',
      ...
      outline: [
        ...
        'hover:bg-(--state-hover) hover:border-focus',
        'active:bg-(--state-pressed)',
        'focus-visible:ring-focus',
      ],
      link: [
