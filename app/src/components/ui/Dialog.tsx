...
export const dialogPopupVariants = tv({
  base: [
    ...
    'rounded-(--shape-xl) bg-modal text-text-primary',
...
export const dialogCloseVariants = tv({
  base: [
    'inline-flex min-h-11 min-w-11 items-center justify-center rounded-(--shape-sm) p-2',
    'text-text-secondary cursor-pointer border border-transparent',
    'transition-[background-color,border-color] duration-100',
    'hover:bg-(--state-hover) hover:text-text-primary hover:border-(--card-border)',
