...
function AppContent() {
  ...
  if (!todasParadas || todasParadas.length === 0) {
    return (
      <div className="flex items-center justify-center h-screen-safe w-screen bg-gray-100 text-gray-800">
  ...
  return (
    <div className="relative flex h-screen-safe w-screen flex-col overflow-hidden bg-background font-['Poppins',sans-serif] md:flex-row">
      <MenuLateral
