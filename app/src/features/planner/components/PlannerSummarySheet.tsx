        ...
        <div className="mb-4 flex items-start justify-between gap-4">
          <div className="flex flex-col gap-0.5">
            ...
            <span className="text-xs tabular-nums text-text-secondary">
              Chegada {formatarHorario(route.arrivalTime)} · {route.transferCount} troca
                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-0.5 pt-0.5">
                      ...
                      <span className="text-xs text-text-secondary">
                        ...
                        {' · '}
                        {formatarHorario((leg as PlannerBusLeg).boardingTime)}
                      </span>
                      <span className="text-xs text-text-secondary">
                        Desça em <strong>{leg.toStopName}</strong>
                        {' · '}
                        {formatarHorario((leg as PlannerBusLeg).arrivalTime)}
                      </span>
                    </div>
                  </>
                )}
