...
export function PointDeltaToast({ event }: PointDeltaToastProps) {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="pointer-events-none animate-gamification-toast fixed bottom-6 right-4 z-[1500] flex max-w-80 items-start gap-3 surface-card-lg bg-card px-4 py-3 text-sm"
    >
