import { AlertTriangle, Bell, Eye, EyeOff, MapPin, Medal, Settings, Trophy, UserCircle2 } from 'lucide-react';
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="rounded-lg border border-card-border bg-background px-3 py-2 text-xs text-text-secondary">
                  ...
                  as informações em tempo real para todos os usuários. Você pode desativar a qualquer
