...
export function LoginPage() {
  ...
  useEffect(() => {
    if (urlErrorCode) {
      trackEvent({ event: 'login_callback_error', category: 'engagement', action: 'login_callback_error', label: urlErrorCode });
    }
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []); // intencionalmente apenas no mount
  ...
  async function handleGoogleLogin() {
    ...
    try {
      ...
      trackEvent({ event: 'login_error', category: 'engagement', action: 'login_error', label: msg });
      setErrorMsg(msg);
