            ...
            <CardContent className="space-y-3 text-sm text-text-secondary">
              ...
              <label className="block space-y-1">
                ...
                <input
                  ...
                  className="surface-card-sm min-h-11 w-full bg-background px-3 py-2"
                  placeholder="Ex: DU10"
                />
              </label>
              <label className="block space-y-1">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                ...
                <button
                  ...
                  className="surface-card-interactive flex min-h-11 items-center justify-center gap-2 bg-background px-4 py-2 font-semibold text-text-primary"
                >
                  <Download size={16} aria-hidden="true" />
                  CSV
                </button>
